...
//alt_drive_gear_retainer = 0; // [1:Solid, 0.25:Ghostly, 0:"Invisible, won't print" ]
...
visualization_hub_shaft_retainer = 
    visualize_info(
        "Drive Gear Retainer", PART_6, hub_shaft_retainer, layout_from_mode(layout), show_parts);
